public class Gemuese extends Zutat{
	...
	public Gemuese(String name, int nummer, float preis, boolean klassisch, String typ, int scheibenAnzahl, int scheibenDicke) {
	...
	public String toString() {
		return super.toString() + "\nScheiben: " + this.scheibenAnzahl + "  |  Dicke der Scheiben: " + this.scheibenDicke;
	}
